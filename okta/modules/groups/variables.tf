...
variable "departments" {
  description = "List of departments to create groups for. Each department gets a group and an auto-assignment rule based on user.department attribute."
  type        = list(string)
...
variable "enable_contractor_group" {
  description = "Create a contractors group with auto-assignment rule"
  type        = bool
  default     = true
}

variable "enable_executive_group" {
  description = "Create an executive leadership group with auto-assignment rule"
  type        = bool
  default     = true
}
