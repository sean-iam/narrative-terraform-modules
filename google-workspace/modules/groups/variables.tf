...
variable "org_domain" {
  description = "Primary domain for group email addresses"
  type        = string
}
...
variable "departments" {
  description = "List of departments to create groups for. Each department gets a Google Group with settings."
  type        = list(string)
